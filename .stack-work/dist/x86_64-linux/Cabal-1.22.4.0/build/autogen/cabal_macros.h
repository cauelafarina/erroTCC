...
/* package persistent-2.2.2.1 */
#define VERSION_persistent "2.2.2.1"
#define MIN_VERSION_persistent(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  2 || \
  (major1) == 2 && (major2) == 2 && (minor) <= 2)

/* package persistent-postgresql-2.2.1.1 */
#define VERSION_persistent_postgresql "2.2.1.1"
...
#define CURRENT_PACKAGE_KEY "erroT_08x5jvRbfCOJSEnt4jiKTy"
